...
function setActiveWhiteLabel(name) {
  ...
  console.log(`✅ Switched to white-label: ${name}`);
}
...
function applyWhiteLabel(name) {
  ...
  console.log('✅ Generated lib/instant.ts');
  ...
  console.log(`\n✨ White-label "${name}" applied successfully!`);
...
try {
  switch (command) {
    ...
    case 'apply': {
      const name = args[1];
      if (!name) {
        console.error('❌ Please provide a white-label name');
